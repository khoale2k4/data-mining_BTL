...
\subsubsection{Kết quả (Tập kiểm tra)}
\begin{itemize}
    \item R-squared (R²): \textbf{0.9591}
    \item MAE (Lỗi tuyệt đối trung bình): \textbf{\$1,769.07}
    \item RMSE (Lỗi toàn phương trung bình): \textbf{\$4,618.92}
\end{itemize}

\subsubsection{Phân tích}
\begin{itemize}
    \item \textbf{Hiệu suất vượt trội:} R² đạt 95,91\%, mô hình đã học được phần lớn quy luật ẩn trong dữ liệu.
    \item \textbf{Sai số giảm mạnh:} 
    \begin{itemize}
        \item MAE giảm từ \$14,561 xuống \$1,769 (giảm 88\%)
        \item RMSE giảm từ \$21,752. xuống \$4,618 (giảm 79\%)
    \end{itemize}
...
\subsubsection{Kết quả (Tập kiểm tra)}
\begin{itemize}
    \item R-squared (R²): \textbf{0.9769}
    \item MAE (Lỗi tuyệt đối trung bình): \textbf{\$1,769.07}
    \item RMSE (Lỗi toàn phương trung bình): \textbf{\$3,469.72}
\end{itemize}

\subsubsection{Phân tích}
\begin{itemize}
    \item \textbf{So sánh với Decision Tree}: R² đã tăng từ 0.9591 lên 0.9769. Quan trọng hơn, chỉ số lỗi MAE/RMSE đã giảm từ $1,769 / $4,618 xuống còn $1,341 / $3,469.
...
R-squared (R²) & 0.0926 & 0.9591 & 0.9769 \\ \hline
MAE & \$14{,}561.79 & \$1{,}769.07 & \$1{,}341.43 \\ \hline
\end{tabularx}
\end{table}
