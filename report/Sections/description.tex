...
\begin{itemize}
    ...
    Ngược lại, nếu dự báo quá thấp, cửa hàng sẽ bị \textit{thiếu hàng}, 
...
Bộ dữ liệu được sử dụng có tên \textit{``Walmart Sales Forecast''}, 
...
\begin{table}[H]
\centering
\caption{Mô tả \texttt{stores.csv}}
\begin{tabular}{|l|l|p{8cm}|}
\hline
\textbf{Tên thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Ý nghĩa} \\ \hline
Store & Integer & Mã định danh của cửa hàng (từ 1 đến 45) \\ \hline
Type & String & Loại cửa hàng (A, B hoặc C) \\ \hline
Size & Integer & Diện tích của cửa hàng \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Tên thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Ý nghĩa} \\ \hline
Store & Integer & Mã cửa hàng (khóa ngoại liên kết với \texttt{stores.csv}) \\ \hline
Date & Date & Ngày tháng năm \\ \hline
Temperature & Double & Nhiệt độ trung bình tại khu vực cửa hàng \\ \hline
Fuel\_Price & Double & Giá nhiên liệu trung bình tại khu vực \\ \hline
MarkDown1–5 & Double & Dữ liệu ẩn danh về 5 loại chương trình giảm giá (\textit{MarkDown}). Giá trị \texttt{NaN} nghĩa là không có giảm giá. \\ \hline
CPI & Double & Chỉ số giá tiêu dùng \\ \hline
Unemployment & Double & Tỷ lệ thất nghiệp tại khu vực \\ \hline
...
\hline
\textbf{Tên thuộc tính} & \textbf{Kiểu dữ liệu} & \textbf{Ý nghĩa} \\ \hline
Store & Integer & Mã cửa hàng \\ \hline
Dept & Integer & Mã định danh phòng ban (ví dụ: quần áo, điện tử, \ldots) \\ \hline
Date & Date & Ngày tháng năm \\ \hline
Weekly\_Sales & Double & \textbf{Biến mục tiêu} (\textit{Target Variable}) – Doanh số bán hàng trong tuần \\ \hline
...
Xây dựng một mô hình có khả năng dự đoán tương đối chính xác giá trị \texttt{Weekly\_Sales} (doanh số hàng tuần) cho từng phòng ban tại từng cửa hàng.

\paragraph{Mục tiêu phụ:}
\begin{itemize}
    \item Thực hiện phân tích khám phá dữ liệu để hiểu rõ đặc điểm của dữ liệu và mối quan hệ giữa các biến 
    ...
    \item Sử dụng và đánh giá một vài thuật toán Data Mining khác nhau để tìm ra mô hình có kết quả dự đoán tốt nhất.
\end{itemize}
